 ...
 */
void Serial2Command::addCommand(const char *command, void (*function)()) {
 ...
 */
void Serial2Command::setDefaultHandler(void (*function)(const char *)) {
 ...
 */
void Serial2Command::clearBuffer() {
  buffer[0] = '\0';
  bufPos = 0;
}
